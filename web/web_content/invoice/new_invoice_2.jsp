                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="${pageContext.request.contextPath}/SearchCustomerServlet">
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="exampleFormControlInput1" class="m-0 font-weight-bold text-primary">VIN</label>
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="submit" class="btn btn-success btn-user btn-block" name="action" value="Add Vehicle"> 
                                        </div>
                                    </div>
                                </form>
                                <div class="form-group row">
